                ...
                <div>
                    ...
                    <div>
                        <p className='text-lg font-semibold flex items-center gap-2'>Quantity :
                            <button onClick={minusQuantity}> <MinusIcon className='w-5 h-5 bg-purple-300' /></button>
                            <span>{catQuantity}</span>
                            <button onClick={pluseQuantity}><PlusIcon className='w-5 h-5 bg-purple-300' /> </button>
                        </p>
                    </div>
                </div>
            </div>
